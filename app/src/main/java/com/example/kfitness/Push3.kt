...
class Push3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.lateralraises))

        mediaPlayer = MediaPlayer.create(this, R.raw.lateralraises)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.Calculate -> {
                    val calculateIntent = Intent(this@Push3, Calculator::class.java)
                ...
                R.id.Home -> {
                    val calculateIntent = Intent(this@Push3, Homepage::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Workout1 -> {
                    val calculateIntent = Intent(this@Push3, Workout::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Setting -> {
                    val calculateIntent = Intent(this@Push3, Profile::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Blog1 -> {
                    val calculateIntent = Intent(this@Push3, Blog::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
        ...
        navigationView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.menu_bench_press -> {
                    ...
                    startActivity(Intent(this@Push3, Push::class.java))
                    true
                }

                R.id.menu_overhead_press -> {
                    // Handle click for Overhead Press
                    startActivity(Intent(this@Push3, Push2::class.java))
                    true
                }
                ...
                R.id.menu_dumbbel_fly -> {
                    ...
                    startActivity(Intent(this@Push3, Push4::class.java))
                    true
                }
