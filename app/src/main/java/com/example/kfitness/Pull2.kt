...
class Pull2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.barbellcurls))

        mediaPlayer = MediaPlayer.create(this, R.raw.barbellcurls)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.Calculate -> {
                    val calculateIntent = Intent(this@Pull2, Calculator::class.java)
                ...
                R.id.Home -> {
                    val calculateIntent = Intent(this@Pull2, Homepage::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Workout1 -> {
                    val calculateIntent = Intent(this@Pull2, Workout::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Setting -> {
                    val calculateIntent = Intent(this@Pull2, Profile::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Blog1 -> {
                    val calculateIntent = Intent(this@Pull2, Blog::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
        ...
        navigationView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.menu_dumbbel_curls -> {
                    ...
                    startActivity(Intent(this@Pull2, Pull::class.java))
                    true
                }
                ...
                R.id.menu_spider_curls -> {
                    ...
                    startActivity(Intent(this@Pull2, Pull3::class.java))
                    true
                }
