...
class Push2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.overheadpress))

        mediaPlayer = MediaPlayer.create(this, R.raw.overheadpress)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.Calculate -> {
                    val calculateIntent = Intent(this@Push2, Calculator::class.java)
                ...
                R.id.Home -> {
                    val calculateIntent = Intent(this@Push2, Homepage::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Workout1 -> {
                    val calculateIntent = Intent(this@Push2, Workout::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Setting -> {
                    val calculateIntent = Intent(this@Push2, Profile::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Blog1 -> {
                    val calculateIntent = Intent(this@Push2, Blog::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
        ...
        navigationView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.menu_bench_press -> {
                    ...
                    startActivity(Intent(this@Push2, Push::class.java))
                    true
                }
                ...
                R.id.menu_lateral_raise -> {
                    ...
                    startActivity(Intent(this@Push2, Push3::class.java))
                    true
                }
                R.id.menu_dumbbel_fly -> {
                    // Handle click for Dumbbell Fly
                    startActivity(Intent(this@Push2, Push4::class.java))
                    true
                }
