...
class Pull3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pull3)
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.spidercurls))

        mediaPlayer = MediaPlayer.create(this, R.raw.spidercurls)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.Calculate -> {
                    val calculateIntent = Intent(this@Pull3, Calculator::class.java)
                ...
                R.id.Home -> {
                    val calculateIntent = Intent(this@Pull3, Homepage::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Workout1 -> {
                    val calculateIntent = Intent(this@Pull3, Workout::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Setting -> {
                    val calculateIntent = Intent(this@Pull3, Profile::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
                ...
                R.id.Blog1 -> {
                    val calculateIntent = Intent(this@Pull3, Blog::class.java)
                    calculateIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                    startActivity(calculateIntent)
                    overridePendingTransition(0, 0)
                    true
...
// Inside your existing setNavigationItemSelectedListener
        navigationView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.menu_dumbbel_curls -> {
                    // Handle click for Bench Press
                    startActivity(Intent(this@Pull3, Pull::class.java))
                    true
                }

                R.id.menu_barbell_curls -> {
                    // Handle click for Overhead Press
                    startActivity(Intent(this@Pull3, Pull2::class.java))
                    true
                }
                R.id.menu_spider_curls -> {
